...
ANIME_HANDLER = DisableAbleCommandHandler("kanime", anime, pass_args=True )
CHARACTER_HANDLER = DisableAbleCommandHandler("kcharacter", character, pass_args=True)
UPCOMING_HANDLER = DisableAbleCommandHandler("kupcoming", upcoming)
MANGA_HANDLER = DisableAbleCommandHandler("kmanga", manga, pass_args=True)
