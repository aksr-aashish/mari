...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "AsunaRobot/elevated_users.json")
...
SUDO_HANDLER = CommandHandler("addsensei", addsudo, run_async=True)
SUPPORT_HANDLER = CommandHandler("addsenpai", addsupport, run_async=True)
TIGER_HANDLER = CommandHandler("addbestfrnd", addtiger, run_async=True)
WHITELIST_HANDLER = CommandHandler(
   "addfrnd", addwhitelist, run_async=True
)
...
UNTIGER_HANDLER = CommandHandler("removebestfrnd", removetiger, run_async=True)
UNWHITELIST_HANDLER = CommandHandler(
   "removefrnd", removewhitelist, run_async=True
)
WHITELISTLIST_HANDLER = CommandHandler(
    "frnds", whitelistlist, run_async=True
)
TIGERLIST_HANDLER = CommandHandler("bestfrnds", tigerlist, run_async=True)
