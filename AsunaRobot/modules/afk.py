...
from AsunaRobot.modules.sql_extended.afk_redis import start_afk, end_afk, is_user_afk, afk_reason
...
import AsunaRobot.modules.helper_funcs.fun_strings as fun
