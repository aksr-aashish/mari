...
def gban(update: Update, context: CallbackContext):
    ...
    if sql.is_user_gbanned(user_id):
        ...
        return
    KOMIGBAN = """
    Yato gami accept the pray of {} ,to kill this monster.
    """
    KOMIGANPIC = "https://te.legra.ph/file/c58804505d26dba27c7c9.mp4"
    first_name = update.effective_user.first_name
    message.reply_video(
        KOMIGANPIC, caption =KOMIGBAN.format(
            escape_markdown(first_name)),
        reply_markup=InlineKeyboardMarkup(
                [
             [
                InlineKeyboardButton(text="Request to reborn", url="https://t.me/komiXsupport"),
             ],
          ]
