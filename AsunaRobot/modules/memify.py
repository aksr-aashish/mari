...
from AsunaRobot import LOGGER, TEMP_DOWNLOAD_DIRECTORY
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./AsunaRobot/resources/Acme-Regular.ttf"
    m_font = ImageFont.truetype(fnt, int((100 / 640) * i_width))
    if ";" in text:
    ...
    current_h, pad = 10, 5
    if upper_text:
        for u_text in textwrap.wrap(upper_text, width=30):
